...
export function sidebar() {
    ...
    sidebarInner.innerHTML = `
                ...
                <div class="sidebar-list">
                    ...
                    <a href="./movie-list.html" menu-close class="sidebar-link" onclick='getMovieList("with_original_language=ka", "Georgian")'>Georgian</a>
                ...
                <div class="sidebar-footer">
                    <p class="copyright">Copyright 2023
                        <a href="https://github.com/gabrielkristesashvili">gabrielkristesashvili</a>
                    </p>
                    <img src="./assest/images/tmdb.svg" width="130" height="17" alt="the movie database logo">
                </div>
        `
