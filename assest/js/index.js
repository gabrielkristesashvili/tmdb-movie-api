...
const heroBanner = function ({ results: movieList }) {
    ...
    for (const [index, movie] of movieList.entries()) {
        ...
        sliderItem.innerHTML = `
                    ...
                    <div class="banner-content">
                        ...
                        <a href="./detail.html" class="btn" onclick="getMovieDetail(${id})">
                            <img src="./assest/images/play_circle.png" width="24" height="24" aria-hidden="true"
                                alt=" play circle">
        ...
        `
        banner.querySelector(".banner-slider")
            .appendChild(sliderItem)
        ...
        controlItem.innerHTML = `
                                    <img src="${imageBaseURL}w154${poster_path}" loading="lazy"
                            alt="Sliide to ${title}" draggable="false" class="img-cover">
        `
        banner.querySelector('.control-inner')
...
const createMovieList = function ({ results: movieList }, title) {
    ...
    for (const movie of movieList) {
        ...
        movieListElem.querySelector(".slider-inner")
